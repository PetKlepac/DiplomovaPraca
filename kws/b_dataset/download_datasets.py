"""
Skript na stiahnutie priečinkov d2/, d4/, d5/ a testing/ z Zenodo.

Spusti tento skript z vnútri priečinka b_dataset/.
...
def main():
    ...
    # === Inteligentná logika rozbaľovania (zabraňuje duplicitným priečinkom) ===
    if len(top_level) == 1 and top_level[0] == "b_dataset":
        print("Detected extra top-level folder 'b_dataset/' → unwrapping it...")

        temp_dir = target_dir / "_temp_extract"
        temp_dir.mkdir(exist_ok=True)
        z.extractall(temp_dir)

        inner_folder = temp_dir / "b_dataset"
    ...
    print(f"\n✓ Extraction complete!")
    print(f" d2/, d4/, d5/ and testing/ should now be in: {target_dir}")
